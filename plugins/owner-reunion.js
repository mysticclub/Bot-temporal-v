...
let texto = `*_🌠 𝙴𝙻 𝙾𝚆𝙽𝙴𝚁 @${m.sender.split`@`[0]} 𝙰 𝙴𝙽𝙿𝙴𝚉𝙰𝙳𝙾 𝚄𝙽𝙰 𝚁𝙴𝚄𝙽𝙸𝙾𝙽 𝙴𝙽𝚃𝚁𝙰𝚁 𝙻𝙾 𝙼𝙰𝚂 𝙿𝚁𝙾𝙽𝚃𝙾 𝙰𝙻 𝙶𝚁𝚄𝙿𝙾 𝙳𝙴𝙻 𝚂𝚃𝙰𝙵𝙵 𝙳𝙴* ${textbot}\n➪ *𝙼𝙾𝚃𝙸𝚅𝙾*: ${text}`
m.reply('*_🚀 Enviando mensaje de reunión a todos los owners de 𝐆𝐚𝐧𝐠 𝟑𝟑𝟑 𝐛𝐨𝐭 𝑶𝒇𝒊𝒄𝒊𝒂𝒍._*')
